...
import com.io.MockDirectoryHelper;
...
public class PersonCompilerTest {
    ...
    public void testConstructor() throws Exception {
        ...
        PersonCompiler personCompiler = new PersonCompiler(peopleLoader, new PersonParseMapper(new FileReader()), new MockDirectoryHelper());
    ...
    public void testLoadAllPeople_ReturnsTheResultsOfAllThreeLoadCalls()
            throws Exception {
        MockPeopleLoader peopleLoader = new MockPeopleLoader();
        PersonCompiler personCompiler = new PersonCompiler(peopleLoader, new PersonParseMapper(new FileReader()));
